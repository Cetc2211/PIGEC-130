"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4358],{35002:function(e,t,n){n.d(t,{ET:function(){return sm},IO:function(){return i5},JU:function(){return ix},PL:function(){return sd},QT:function(){return sh},ad:function(){return iO},ar:function(){return i7},hJ:function(){return iR},pl:function(){return sf}});var r,i,s,a,o=n(99279),l=n(42680),u=n(19053),h=n(71028),c=n(76552),d=n(4575);n(25566);var f=n(86300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nx{constructor(){this.Tr=new es(nL.Er),this.dr=new es(nL.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){let n=new nL(e,t);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Vr(new nL(e,t))}mr(e,t){e.forEach(e=>this.removeReference(e,t))}gr(e){let t=new K(new B([])),n=new nL(t,e),r=new nL(t,e+1),i=[];return this.dr.forEachInRange([n,r],e=>{this.Vr(e),i.push(e.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){let t=new K(new B([])),n=new nL(t,e),r=new nL(t,e+1),i=tp();return this.dr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nL(e,0),n=this.Tr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nL{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return K.comparator(e.key,t.key)||M(e.wr,t.wr)}static Ar(e,t){return M(e.wr,t.wr)||K.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sh(e){e=iS(e,ib);let t=iS(e.firestore,iV);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ic({next:o=>{s.Za(),t.enqueueAndForget(()=>rU(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rz(new e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rP(e,a)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(iM(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sc(e);return new so(e,i,t._key,r,new sa(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sc extends si{constructor(e){super(),this.firestore=e}convertBytes(e){return new iF(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ib(this.firestore,null,t)}}function sd(e){e=iS(e,ik);let t=iS(e.firestore,iV),n=iM(t),r=new sc(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
