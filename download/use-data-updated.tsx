...
const checkAndInjectStrategies = async (studentId: string, addObs: Function) => {
    ...
    return (
        <DataContext.Provider value={{
            ...
            calculateFinalGrade, calculateDetailedFinalGrade, getStudentRiskLevel, fetchPartialData, triggerPedagogicalCheck, syncPublicData, forceCloudSync, uploadLocalToCloud, syncStatus,
        }}>
            {children}
