...
`.trim();
    ...
    return (
        <Card className="shadow-lg">
            <CardHeader>
                <CardTitle>Flujo de Derivación y Contrarreferencia</CardTitle>
                <CardDescription>
                ...
                {!showTemplate ? (
                    <div className="flex flex-col items-center justify-center text-center p-6 border-dashed border-2 rounded-lg">
                        ...
                        <p className="mb-4 text-gray-600">
                            Activa este flujo si la valoración sugiere la necesidad de una intervención especializada externa (ej. Psiquiatría, Neurología, Endocrinología).
                        </p>
                        <Button 
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-semibold text-gray-800">Plantilla de Carta de Canalización</h3>
                        <Textarea
